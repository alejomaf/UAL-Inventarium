    ...
    <div class="container">
        <div class="row align-items-center">
            <div id="variableArea" class="col align-self-center">
                ...
                <br>
                    <h1 class="text-center font-weight-bold">Iniciar sesión</h1>
                    <br>
                    <div class="form-group">
                        <label class="font-italic">Correo electrónico</label>
                        <input type="email" id="email" name="email" placeholder="Ingrese su correo electrónico" class="form-control" required>
                    </div>
                    <div class="form-group">
                        <label class="font-italic">Contraseña</label>
                        <input type="password" id="password" name="password" placeholder="Ingrese su contraseña" class="form-control" required>
                    </div>
                    <small id="nameHelp" class="form-text text-primary"><a href="http://localhost/UALInventarium/recoverPassword.php">¿Has olvidado la contraseña?</a></small><br>
                    <input type="hidden" id="plataforma" name="plataforma" value=0 class="form-control"><br>
                    <div class="form-group">
                    ...
                    <br>
                    <button type="btn" onclick="cambiarObjeto('registration/register.php');" id="registrarse" class="btn btn-secondary btn-block">Registrase</button>
                </form>
            </div>
        </div>
    </div>
