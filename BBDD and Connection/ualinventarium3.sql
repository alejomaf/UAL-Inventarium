...
-- -----------------------------------------------------
-- Table `ualinventarium`.`Kit`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ualinventarium`.`Kit` (
  `idKit` INT NOT NULL AUTO_INCREMENT,
  `GrupoObjetos_idGrupoObjetos` INT NOT NULL,
  `Ubicacion_idUbicacion` INT NULL,
  `disponible` TINYINT NULL,
  `eliminado` TINYINT NULL DEFAULT 0,
  PRIMARY KEY (`idKit`, `GrupoObjetos_idGrupoObjetos`),
  INDEX `fk_Kit_GrupoObjetos1_idx` (`GrupoObjetos_idGrupoObjetos` ASC),
  INDEX `fk_Kit_Ubicacion1_idx` (`Ubicacion_idUbicacion` ASC),
  CONSTRAINT `fk_Kit_GrupoObjetos1`
    FOREIGN KEY (`GrupoObjetos_idGrupoObjetos`)
    REFERENCES `ualinventarium`.`GrupoObjetos` (`idGrupoObjetos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Kit_Ubicacion1`
    FOREIGN KEY (`Ubicacion_idUbicacion`)
    REFERENCES `ualinventarium`.`Ubicacion` (`idUbicacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `ualinventarium`.`Prestado` (
  ...
  INDEX `fk_Prestado_Kit1_idx` (`Kit_idKit` ASC),
  ...
  CONSTRAINT `fk_Prestado_Objeto1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_Prestado_Kit1`
    FOREIGN KEY (`Kit_idKit`)
    REFERENCES `ualinventarium`.`Kit` (`idKit`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
