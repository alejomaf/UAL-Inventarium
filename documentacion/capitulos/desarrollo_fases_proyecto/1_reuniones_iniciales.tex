...
\begin{figure}
    \begin{center}
        \includegraphics[scale=0.5]{web_design_adobe_xd/grupo_objetos.png}
        \includegraphics[scale=0.5]{web_design_adobe_xd/objeto_disponible.png}
...
\begin{figure}
    \begin{center}
        \includegraphics[scale=0.5]{web_design_adobe_xd/usuarios_buscados.png}
        \includegraphics[scale=0.5]{web_design_adobe_xd/usuario.png}
